...
const Contact = ({ id, openReservationModal }) => {
  ...
  useEffect(() => {
    ...
    if (mapRef.current) {
      animationObserver.observe(mapRef.current);
    }
    ...
    return () => {
      ...
      if (mapRef.current) animationObserver.unobserve(mapRef.current);
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-10">
          ...
          <div 
            ...
            className="w-full lg:w-1/2 bg-white/90 dark:bg-gray-800/90 p-6 sm:p-8 md:p-10 rounded-2xl shadow-xl opacity-0 transform translate-x-8 transition-all duration-700 ease-out backdrop-blur border-l-4 border-wine"
          >
            <h3 className="text-3xl font-bold mb-8 text-wine dark:text-wine/90 border-b-2 border-wine/20 pb-4">La Nostra Sede</h3>
                ...
                <div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 flex items-center gap-2">
                      Email: 
                      <a 
                        href="mailto:info@miamore-restaurant.com" 
                        className="text-wine dark:text-wine/90 hover:underline font-medium">
            ...
            >
              ...
              <button 
                ...
                className="inline-block bg-amber-600 text-white px-6 py-3 rounded-full hover:bg-amber-700 transition-all duration-300 transform hover:scale-105 font-medium shadow-lg hover:shadow-xl flex items-center gap-2"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div 
            ...
            className="w-full lg:w-1/2 overflow-hidden rounded-2xl shadow-xl h-[400px] sm:h-[450px] lg:h-auto opacity-0 transform -translate-x-8 transition-all duration-700 ease-out"
          >
            <div className="h-full relative">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.215685247323!2d-73.98629242414937!3d40.75895097122677!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25855c6480299%3A0x55194ec5a1ae072e!2sTimes%20Square!5m2!1s!2s" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }}
                allowFullScreen="" 
                loading="lazy"
                title="Mi Amore Restaurant Location"
                className="absolute inset-0"
              ></iframe>
              
              {/* Map Overlay */}
              <div className="absolute top-4 left-4 bg-white/90 dark:bg-gray-800/90 p-4 rounded-lg shadow-lg backdrop-blur-sm border-l-2 border-wine">
                <h4 className="font-bold text-wine dark:text-wine/90">Mi Amore Restaurant</h4>
                <p className="text-sm text-gray-700 dark:text-gray-300">123 Culinary Avenue</p>
              </div>
            </div>
          </div>
        </div>
